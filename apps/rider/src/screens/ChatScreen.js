...
import {
  View, Text, StyleSheet, FlatList, KeyboardAvoidingView, Platform, ActivityIndicator,
} from 'react-native';
...
// The mirror of the customer app's ChatScreen — same table, same window
// (open once a rider claims the order, closed on handover), same reasoning:
// the Call button on ActiveDelivery stays for whoever can't type and ride.
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <Text style={styles.empty}>
              Say hello — {peerName || 'the customer'} will see it here.
            </Text>
          }
          renderItem={({ item }) => {
